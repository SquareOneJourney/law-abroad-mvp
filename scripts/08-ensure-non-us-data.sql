-- Ensure we have non-US law data in the database
-- This script will insert sample data for multiple countries if it doesn't exist
...
SELECT 'Final verification - Countries with laws:' as debug_info;
SELECT 
    l.country_code, 
